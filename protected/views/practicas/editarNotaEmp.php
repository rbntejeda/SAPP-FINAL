...
/************************************************************************/
/*  Nombre del archivo:   editarNotasEmp.php                               */
/* Descripción:  Vista correspondiente a la edicion de notas de alumno.  */
/*                Notas correspondiente al encargado en la empresa donde*/
/*                            el alumno realizo la practica            */
...
<div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title">Editar nota de empresa para <?php echo $nota->PER_NOMBRE.' - Practica '.$nota->PRA_TIPO?></h3>
      </div>
...
<table class="table">
      ...
      <tbody>
        ...
        <tr>
             <td><?php echo $nota->PRA_EVAEMPRESA?></td>  
             <!-- NumberField() genera una entrada de campo de numero -->
              <td><?php echo $form->numberField($nota,'PRA_EVAEMPRESA',
...
<?php echo $form->error($nota,'PRA_EVAEMPRESA');?>
    </div>
      </div>
    </div>
